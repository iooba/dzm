...
var en = {
  'myExtension.name': 'Scratch to Verilog',
...
function peg$SyntaxError(message, expected, found, location) {
  var self = Error.call(this, message); // istanbul ignore next Check is a necessary evil to support older environments
...
function peg$parse(input, options) {
  ...
  function peg$parseFunction() {
    var s0, s1, s2, s4, s5, s6, s7, s9, s11;
    peg$silentFails++;
    s0 = peg$currPos;
    s1 = peg$parseString();
      ...
      value: function __declare_vars() {
        ...
        this.vars.forEach(function (v) {
          ...
          switch (value.type) {
            case 'Blink':
              varCodes.push([
                'wire blink_'.concat(value.clock, ';'),
                'Blink Blink_'
                  .concat(value.clock, '(CLK,blink_')
                  .concat(value.clock, ');'),
                'defparam Blink_'
                  .concat(value.clock, ".CNT_MAX = 31'd")
                  .concat(value.clock, ';'),
              ]);
              break;
          }
