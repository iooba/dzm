...
function peg$parse(input, options) {
  ...
  var peg$f0 = function(name, head, tail) { return [head].concat(tail); };
  var peg$f1 = function(name, args) { return { type: "function", name, args: args ? args.flat() : [] } };
  var peg$f2 = function(name, index) { return { type: "ident", name, index } };
  var peg$f3 = function(number) { return { type: "number", number } };
  var peg$f4 = function(text) { return text.join("") };
